...
.PHONY: run
run: manifests generate fmt vet ## Run the operator controller from your host.
	go run ./cmd/operator
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name myelin-builder
	$(CONTAINER_TOOL) buildx use myelin-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm myelin-builder
	rm Dockerfile.cross
